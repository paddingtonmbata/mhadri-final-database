...
urlpatterns = [
    ...
    path('course_data_search/', views.CourseDataSearch.as_view(), name='course-data-search'),
    path('courses_data/', views.CourseDataList.as_view(), name='course-data-list'),
    ...
    path('institution_counts/', views.institution_counts, name='institution_counts'),
    ...
    path('institution_counts_by_code/<str:country_code>/', views.institution_counts_by_code, name='institution_counts_by_code'),
